...
import com.example.goeatnow.ProviderType.*
...
class mainActivity : AppCompatActivity() {
    ...
    private fun session(){
        ...
        if (email != null && provider != null){
            ...
            showHome(email, valueOf(provider))
        }
    ...
    private fun setup(){
        ...
        googleButton.setOnClickListener {
            ...
            startActivityForResult(googleClient.signInIntent, GOOGLE_SIGN_IN)  /* .signInIntent, GOOGLE_SIGN_IN) */
